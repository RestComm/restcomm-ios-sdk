...
+ (void) setupUserDefaults
{
    ...
    NSDictionary *basicDefaults = @{
                                    ...
                                    @"sip-password" : @"1234",
                                    @"sip-registrar" : @"cloud.restcomm.com:5060",
                                    ...
                                    @[
                                        ...
                                        @[@"Hello World App", @"sip:1235@cloud.restcomm.com"],
                                        @[@"Conference App", @"sip:1311@cloud.restcomm.com"],
                                        @[@"Team Call", @"sip:+15126001502@cloud.restcomm.com"],
                                        ],
