 ...
 * it has been taken from goption.c $1.47$ in cvs.gnome.org.
 * #if notyet leaves out internationalization parts. 
 *
...
#define _(x) (x)
#define g_option_group_set_translation_domain(group, domain) ((void)0)
#endif
