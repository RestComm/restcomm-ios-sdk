...
then
	...
	# --------
	# Create a custom keychain, ios-build.keychain (not much interested for password as it will be hosted an CI env and removed right after)
	security create-keychain -p keychain_password ios-build.keychain

	# Make the ios-build keychain default, so xcodebuild will use it for signing
