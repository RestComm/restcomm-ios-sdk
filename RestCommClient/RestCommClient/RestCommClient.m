...
- (id)init {
    if (self = [super init]) {
        ...
        self.errors = @{
                        ...
                        @(ERROR_TEXT_MESSAGE_GENERIC) : @"Text message error",
                        @(ERROR_TEXT_MESSAGE_NOT_FOUND) : @"Text message error",
                        @(ERROR_TEXT_MESSAGE_AUTHENTICATION) : @"Text message error",
                        @(ERROR_TEXT_MESSAGE_TIMEOUT) : @"Text message error",
