...
- (id)init {
    if (self = [super init]) {
        ...
        self.errors = @{
                        ...
                        @(ERROR_CALLING_GENERIC) : @"Generic call error",
                        @(ERROR_CALLING_NOT_FOUND) : @"Called party not found",
                        @(ERROR_CALLING_AUTHENTICATION) : @"Error authenticating user for the call",
                        @(ERROR_CALLING_TIMEOUT) : @"Call timed out",
                        @(ERROR_TEXT_MESSAGING_GENERIC) : @"Text message error",
                        @(ERROR_TEXT_MESSAGING_NOT_FOUND) : @"Text message error",
                        @(ERROR_TEXT_MESSAGING_AUTHENTICATION) : @"Text message error",
                        @(ERROR_TEXT_MESSAGING_TIMEOUT) : @"Text message error",
                        @(ERROR_REGISTERING_GENERIC) : @"Registration generic error",
                        @(ERROR_REGISTERING_AUTHENTICATION) : @"Error authenticating with Restcomm",
                        @(ERROR_REGISTERING_TIMEOUT) : @"Registration with Restcomm timed out",
